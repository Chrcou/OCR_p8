...
(function(window) {
     ...
     * @param {number} id 
     * @param {string} title the text of the todo before editing
     */
    ...
    /**
     * When the edition of a todo is canceled, this function will handle the exiting of edition mode
     * @param {Function} handler what to do with the item id
     */
